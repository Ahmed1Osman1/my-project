...
class AdminController extends Controller
{
    ...
    public function dashboard(){
        $countries = country::all(); // Assuming "Country" is the model for countries
        $languages = countrylanguage::all(); // Assuming "Language" is the model for languages
        $cities = city::all(); // Assuming "City" is the model for cities
    
        return view('dashboard' ,compact('countries', 'languages', 'cities'));
    }
